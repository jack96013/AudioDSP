...
#define BOARD_BLUTTOOTH_UART_RX_PIN		
#define BOARD_BLUTTOOTH_UART_TX_PIN		

#define BOARD_BUTTON_1_PIN				34
#define BOARD_EC11_SW_PIN       35
#define BOARD_EC11_A_PIN        36
#define BOARD_EC11_B_PIN        39

#define BOARD_OLED_CS_PIN       5
#define BOARD_OLED_DC_PIN       15
#define BOARD_OLED_RES_PIN      14
